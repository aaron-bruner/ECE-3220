...
int main(int argc, char **argv){
        ...
        while(remaining_tasks > 0){
            ...
            if(running == 0){
                ...
                if(tasks[thread_choice]->remaining_time == 0){
                    ...
                    tasks[thread_choice]->response_time = tasks[thread_choice]->completion_time-tasks[thread_choice]->arrival_time-1;
                    remaining_tasks--;
                }
            }
        }
        ...
        while(remaining_tasks > 0){
            ...
            if(running == 0){ //if should wait, wait
                ...
                if(rover->remaining_time == 0){
                    remaining_tasks--;
                    rover->completion_time = current_time+1;
    ...
    while(rover != NULL){
        printf(" %c     %2d      %2d       %2d        %2d     %2d\n",
               ...
               rover->completion_time,rover->response_time+1,rover->wait_time);
