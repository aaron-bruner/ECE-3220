 ...
 *
 *  I really like switch cases but I couldn't get the global variables to work together when it was in a case, lol.
 */
...
int main(int argc, char **argv){
    ...
    if(flag == FIFO){
        ...
        printf("\n----------------------------------\n");
        int clock = 0, ptr, numTasks = numTask+1;
        ...
        printf("\n----------------------------------\n");
        int clock = 0, numTasks = numTask+1;
        rover = tasks[numTask];
